...
## Project Structure
    ...
    ├── testapiautoconnect_112745  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112745`
...
2. Clone this repo and `cd testapiautoconnect_112745`
